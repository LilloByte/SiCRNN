...
from dataset_all_data import ApneaDataset_all
...
def start_train():
    ...
    writer = SummaryWriter(comment=f'___{exp_n}')
    model = None  
    # define model########################
    if n_conv == 2:
        if inp == 8:
...
if __name__ == "__main__":
    ...
    num_epochs = 100 
    waights_path = "/home/dlillini/Apnee/apnea_detection_v3/paremters_tuning/weights_new_split"
    data_path = "/disks/disk1/dlillini/PSG_Audio/new_split/split2/train/"
